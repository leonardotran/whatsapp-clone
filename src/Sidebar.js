          ...
          <div className="siderbar__wrapper">
            ...
            <div className="sidebar__header">
              ...
              <p className="sidebar__greeting mobile__tag">
                {" "}
                <a
                  href="https://github.com/leonardotran"
                  style={{ color: "white" }}
                >
                  Made by <span style={{ color: "white" }}>Loc Tran</span>
                </a>
              </p>
        ...
        <div className={"sidebar"}>
          <div className="sidebar__header">
            ...
            <p className="sidebar__greeting">
              {" "}
              <a href="https://github.com/leonardotran">
                Made by <span style={{ color: "blue" }}>Loc Tran</span>
              </a>
            </p>
            <div className="sidebar__headerRight">
              <IconButton>
